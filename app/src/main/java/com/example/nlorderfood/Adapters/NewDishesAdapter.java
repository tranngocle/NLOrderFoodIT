...
public class NewDishesAdapter extends FirestoreRecyclerAdapter<Food,NewDishesAdapter.FoodViewHolder> {
        ...
        holder.addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (res.getCount()==0){
                    ...
                    if (isAddedToCart){
                        String message="Mặt hàng đã thêm vào giỏ hàng";
                        Toast.makeText(v.getContext(), message,Toast.LENGTH_LONG).show();
                    }
                    else {
                        String message="Lỗi khi thêm vào giỏ hàng";
                    }
                }
                else{
                    String message="Mặt hàng đã sẵn sàng để thêm";
                    Toast.makeText(v.getContext(), message,Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public FoodViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.newdish_tempate,parent,false);
