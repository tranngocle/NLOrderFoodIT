        ...
        addTocartBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (res.getCount()==0){
                    ...
                    if (isAddedToCart){
                        String message="Mặt hàng đã được thêm vào giỏ hàng";
                        Toast.makeText(FoodDetail.this, message, Toast.LENGTH_LONG).show();
                    }
                    else {
                        String message="Lỗi khi thêm mặt hàng";
                        Toast.makeText(FoodDetail.this, message, Toast.LENGTH_LONG).show();
                    }
                }
                else{
                    String message="Mặt hàng đã sẵn dàng để thêm";
                    Toast.makeText(FoodDetail.this, message, Toast.LENGTH_LONG).show();
                }
            }
        });
        favBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (res.getCount()==0){
                    ...
                    if (isAddedToCart){
                        String message="Đã thêm vào mặt hàng yêu thích";
                        Toast.makeText(FoodDetail.this, message, Toast.LENGTH_LONG).show();
                    }
                    else {
                        String message="Lỗi khi thêm vào mặt hàng yêu thích";
                        Toast.makeText(FoodDetail.this, message, Toast.LENGTH_LONG).show();
                    }
                }
                else{
                    String message="Mặt hàng đã sẵn sàng trong danh sách yêu thích";
                    Toast.makeText(FoodDetail.this, message, Toast.LENGTH_LONG).show();
                }
            }
        });
